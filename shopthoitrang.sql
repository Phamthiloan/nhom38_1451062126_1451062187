...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 14, 2017 lúc 06:12 CH
...
CREATE TABLE `baiviet` (
  ...
  `ten_bhat` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ma_tloai` int(10) DEFAULT NULL,
  `tomtat` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `baiviet` varchar(2000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ma_tgia` int(10) DEFAULT NULL,
...
--
ALTER TABLE `baiviet`
  ADD CONSTRAINT `baiviet_ibfk_1` FOREIGN KEY (`ma_tloai`) REFERENCES `theloai` (`ma_theloai`);

--
-- Các ràng buộc cho bảng `tacgia`
--
ALTER TABLE `tacgia`
  ADD CONSTRAINT `tacgia_ibfk_1` FOREIGN KEY (`ma_tgia`) REFERENCES `baiviet` (`ma_tgia`);
--
...
('root', 'catalog', 'table', 'shopthoitrangnhungloan', ''),
('root', 'transaction', 'table', 'shopthoitrangnhungloan', ''),
('root', 'user', 'table', 'shopthoitrangnhungloan', '');
...
('root', '[{\"db\":\"shopthoitrangnhungloan\",\"table\":\"transaction\"},{\"db\":\"shopthoitrangnhungloan\",\"table\":\"product\"},{\"db\":\"shopthoitrangnhungloan\",\"table\":\"catalog\"},{\"db\":\"shopthoitrangnhungloan\",\"table\":\"user\"},{\"db\":\"shopthoitrangnhungloan\",\"table\":\"admin\"},{\"db\":\"shopthoitrangnhungloan\",\"table\":\"order\"},{\"db\":\"Shopthoitrangnhungloan\",\"table\":\"admin\"},{\"db\":\"music\",\"table\":\"baiviet\"},{\"db\":\"music\",\"table\":\"theloai\"},{\"db\":\"music\",\"table\":\"tacgia\"}]');
...
('root', '2017-05-12 18:41:38', '{\"collation_connection\":\"utf8mb4_unicode_ci\",\"lang\":\"vi\"}');
...
ALTER TABLE `pma__savedsearches`
  MODIFY `id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT;--
-- Cơ sở dữ liệu: `shopthoitrangnhungloan`
--
CREATE DATABASE IF NOT EXISTS `shopthoitrangnhungloan` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `shopthoitrangnhungloan`;
...
ALTER TABLE `transaction`
  ADD PRIMARY KEY (`id`);
--
-- Cơ sở dữ liệu: `tacgia`
--
CREATE DATABASE IF NOT EXISTS `tacgia` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `tacgia`;
--
-- Cơ sở dữ liệu: `test`
--
